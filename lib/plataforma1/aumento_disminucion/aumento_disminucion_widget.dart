...
import 'aumento_disminucion_model.dart';
export 'aumento_disminucion_model.dart';

class AumentoDisminucionWidget extends StatefulWidget {
  const AumentoDisminucionWidget({super.key});

  static String routeName = 'AumentoDisminucion';
  static String routePath = '/aumentoDisminucion';

  @override
  State<AumentoDisminucionWidget> createState() =>
      _AumentoDisminucionWidgetState();
}

class _AumentoDisminucionWidgetState extends State<AumentoDisminucionWidget> {
  late AumentoDisminucionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AumentoDisminucionModel());
