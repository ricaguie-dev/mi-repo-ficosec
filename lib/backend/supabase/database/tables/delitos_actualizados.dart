...
class DelitosActualizadosTable extends SupabaseTable<DelitosActualizadosRow> {
  @override
  String get tableName => 'DelitosActualizados';

  @override
  DelitosActualizadosRow createRow(Map<String, dynamic> data) =>
      DelitosActualizadosRow(data);
}

class DelitosActualizadosRow extends SupabaseDataRow {
  DelitosActualizadosRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => DelitosActualizadosTable();
